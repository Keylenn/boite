import './style.css'
import createBox, { createStorageBox, createJsonBinBox, ProtectedBox } from '../lib'
...
function setupCounter(element: HTMLButtonElement, {box, customHtml}: {box: ProtectedBox; customHtml?: (count: number) => string}) {
  const setCounter = () => {
